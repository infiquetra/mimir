...
void main() {
  ...
  group('Dashboard Screen Integration Tests', () {
    testWidgets('TC-DASH-001: All 7 cards render without errors', (
      tester,
    ) async {
    ...
    testWidgets('TC-DASH-002: No character shows empty state', (tester) async {
    ...
    testWidgets('TC-DASH-003: Pull-to-refresh triggers provider invalidation', (
      tester,
    ) async {
    ...
    testWidgets('TC-DASH-004: CombinedWealthCard shows formatted ISK', (
      tester,
    ) async {
    ...
    testWidgets('TC-DASH-005: TrainingOverviewCard shows skill name (not ID)', (
      tester,
    ) async {
    ...
    testWidgets('TC-DASH-006: QuickActionsCard buttons are tappable', (
      tester,
    ) async {
      // GIVEN: Dashboard with test character
      await tester.pumpWidget(
    ...
    testWidgets('TC-DASH-007: Dashboard handles multiple characters', (
      tester,
    ) async {
    ...
    testWidgets('TC-DASH-008: Dashboard responsive grid layout', (
      tester,
    ) async {
