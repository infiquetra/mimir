...
void main() {
  ...
  group('Skill Plans CRUD Tests', () {
    testWidgets('TC-PLAN-001: Create new skill plan', (tester) async {
    ...
    testWidgets('TC-PLAN-002: Plan validation requires name', (tester) async {
    ...
    testWidgets('TC-PLAN-003: Edit existing skill plan', (tester) async {
    ...
    testWidgets('TC-PLAN-004: Delete skill plan with confirmation', (
      tester,
    ) async {
      // GIVEN: Skills screen with existing plan
      final characterId = 12345678;
    ...
    testWidgets('TC-PLAN-005: Plan progress calculation displays correctly', (
      tester,
    ) async {
    ...
    testWidgets('TC-PLAN-006: Training time estimate displays', (tester) async {
  ...
  group('Skill Plans Edge Cases', () {
    testWidgets('Empty plan (no skills) shows 0% progress', (tester) async {
    ...
    testWidgets('Completed plan (100%) shows no time estimate', (tester) async {
