...
void main() {
  ...
  group('Skill Plan Detail Screen Tests', () {
    testWidgets('TC-DETAIL-001: Displays plan header with name', (
      tester,
    ) async {
    ...
    testWidgets('TC-DETAIL-002: Shows progress bar and stats', (tester) async {
      const characterId = 12345;
      const planId = 1;
    ...
    testWidgets('TC-DETAIL-003: Lists skills in plan', (tester) async {
      const characterId = 12345;
      const planId = 1;
    ...
    testWidgets('TC-DETAIL-004: Remove skill from plan', (tester) async {
      const characterId = 12345;
      const planId = 1;
    ...
    testWidgets('TC-DETAIL-005: Empty plan shows add skills prompt', (
      tester,
    ) async {
      const characterId = 12345;
      const planId = 1;
