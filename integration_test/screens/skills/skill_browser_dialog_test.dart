...
void main() {
  ...
  group('Skill Browser Dialog Tests', () {
    testWidgets('TC-BROWSER-001: Displays skill groups', (tester) async {
      ...
      await tester.pumpWidget(
        TestApp(
          ...
          home: Scaffold(body: SkillBrowserDialog(planId: planId)),
        ),
      );
    ...
    testWidgets('TC-BROWSER-002: Expand group shows skills', (tester) async {
      const characterId = 12345;
      const planId = 1;
    ...
    testWidgets('TC-BROWSER-003: Checkbox selection works', (tester) async {
      const characterId = 12345;
      const planId = 1;
    ...
    testWidgets('TC-BROWSER-004: Selection count updates', (tester) async {
      const characterId = 12345;
      const planId = 1;
