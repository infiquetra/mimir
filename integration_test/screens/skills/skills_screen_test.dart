...
void main() {
  ...
  group('Skills Screen Integration Tests', () {
    testWidgets('TC-SKILL-001: Skill queue items display', (tester) async {
    ...
    testWidgets('TC-SKILL-002: Currently training skill is highlighted', (
      tester,
    ) async {
      // GIVEN: Skills screen with active skill queue
      final characterId = 12345678;
    ...
    testWidgets('TC-SKILL-003: Empty queue shows empty state', (tester) async {
    ...
    testWidgets('TC-SKILL-004: Skill names resolved from SDE', (tester) async {
    ...
    testWidgets('TC-SKILL-005: Time remaining displays correctly', (
      tester,
    ) async {
      // GIVEN: Skills screen with active skill queue
      final characterId = 12345678;
    ...
    testWidgets('TC-SKILL-006: No character shows empty state', (tester) async {
      // GIVEN: Skills screen with NO character
      await tester.pumpWidget(
        const TestApp(initialCharacter: null, home: SkillsScreen()),
      );
    ...
    testWidgets('TC-SKILL-007: Multiple queued skills display in order', (
      tester,
    ) async {
    ...
    testWidgets('TC-SKILL-008: Total SP header displays formatted value', (
      tester,
    ) async {
    ...
    testWidgets('TC-SKILL-010: Skill Plans tab displays plans', (tester) async {
    ...
    testWidgets('TC-SKILL-011: Plan cards show progress information', (
      tester,
    ) async {
    ...
    testWidgets('TC-SKILL-012: Empty plans state displays correctly', (
      tester,
    ) async {
    ...
    testWidgets('TC-SKILL-013: FAB for creating new plan is visible', (
      tester,
    ) async {
      ...
      await tester.pumpWidget(
        TestApp(
          ...
          setupDatabase: (db) async {
            ...
            await db
                .into(db.skillPlans)
                .insert(SkillPlanFixtures.emptyPlan(characterId: characterId));
          },
          home: const SkillsScreen(),
        ),
      );
    ...
    testWidgets('TC-SKILL-014: Edit and delete buttons on plan cards', (
      tester,
    ) async {
      // GIVEN: Skills screen with skill plans
      final characterId = 12345678;
