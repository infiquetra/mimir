...
void main() {
  ...
  group('Onboarding Flow Integration Tests', () {
    testWidgets('TC-ONB-001: 3 steps navigate correctly', (tester) async {
      // GIVEN: Onboarding screen
      await tester.pumpWidget(const TestApp(home: OnboardingScreen()));
    ...
    testWidgets('TC-ONB-002: Skip marks onboarding complete', (tester) async {
      // GIVEN: Onboarding screen
      await tester.pumpWidget(const TestApp(home: OnboardingScreen()));
    ...
    testWidgets('TC-ONB-003: Step indicators show progress', (tester) async {
      // GIVEN: Onboarding screen
      await tester.pumpWidget(const TestApp(home: OnboardingScreen()));
    ...
    testWidgets('TC-ONB-004: Back button navigates to previous step', (
      tester,
    ) async {
    ...
    testWidgets('TC-ONB-005: Startup behavior options display in step 3', (
      tester,
    ) async {
      // GIVEN: Onboarding screen
      await tester.pumpWidget(const TestApp(home: OnboardingScreen()));
    ...
    testWidgets('TC-ONB-006: All steps render without errors', (tester) async {
      // GIVEN: Onboarding screen
      await tester.pumpWidget(const TestApp(home: OnboardingScreen()));
