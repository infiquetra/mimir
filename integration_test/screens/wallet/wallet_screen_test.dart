...
void main() {
  ...
  group('Wallet Screen Integration Tests', () {
    testWidgets('TC-WALL-001: Balance cards row shows 4 cards', (tester) async {
    ...
    testWidgets('TC-WALL-003: No character shows empty state', (tester) async {
      // GIVEN: Wallet screen with NO character
      await tester.pumpWidget(
        const TestApp(initialCharacter: null, home: WalletScreen()),
      );
    ...
    testWidgets('TC-WALL-004: Wallet journal displays transactions', (
      tester,
    ) async {
    ...
    testWidgets('TC-WALL-005: Market transactions show item names', (
      tester,
    ) async {
    ...
    testWidgets('TC-WALL-006: Balance ISK displays formatted', (tester) async {
    ...
    testWidgets('TC-WALL-007: TabBarView renders without overflow', (
      tester,
    ) async {
      // GIVEN: Wallet screen with test character
      await tester.pumpWidget(
      ...
      expect(
        column.children.any(
          (child) => child is Expanded && child.child is TabBarView,
        ),
        isTrue,
    ...
    testWidgets('TC-WALL-008: 30-day summary displays in Overview', (
      tester,
    ) async {
