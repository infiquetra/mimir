...
void main() {
  ...
  group('Settings Screen Integration Tests', () {
    testWidgets('TC-SET-001: Startup behavior radio buttons work', (
      tester,
    ) async {
      // GIVEN: Settings screen
      await tester.pumpWidget(const TestApp(home: SettingsScreen()));
    ...
    testWidgets('TC-SET-002: SDE update card renders', (tester) async {
      // GIVEN: Settings screen
      await tester.pumpWidget(const TestApp(home: SettingsScreen()));
    ...
    testWidgets('TC-SET-003: About card displays app info', (tester) async {
      // GIVEN: Settings screen
      await tester.pumpWidget(const TestApp(home: SettingsScreen()));
    ...
    testWidgets('TC-SET-004: Settings sections are organized', (tester) async {
      // GIVEN: Settings screen
      await tester.pumpWidget(const TestApp(home: SettingsScreen()));
    ...
    testWidgets('TC-SET-005: Settings load without errors', (tester) async {
      // GIVEN: Settings screen
      await tester.pumpWidget(const TestApp(home: SettingsScreen()));
