...
void main() {
  group('Feature F5: Encounter List UI and Multi-Pane Analysis View', () {
    ...
    testWidgets('T1.1: Empty state display when no encounters exist', (
      tester,
    ) async {
    ...
    testWidgets(
      'T1.3: Selecting an encounter shows its details in the multi-pane view',
      (tester) async {
    ...
    testWidgets('T1.4: Responsive layout behavior (mobile vs desktop)', (
      tester,
    ) async {
    ...
    testWidgets(
      'T1.5: Encounter selection changes update the analysis pane correctly',
      (tester) async {
    ...
    testWidgets(
      'T2.1: Very long encounter lists scroll gracefully without performance loss',
      (tester) async {
    ...
    testWidgets(
      'T2.2: Selection behavior when the previously selected encounter is deleted/filtered',
      (tester) async {
    ...
    testWidgets(
      'T2.3: Very long character names or encounter titles truncate properly',
      (tester) async {
    ...
    testWidgets(
      'T2.4: Loading states when an encounter analysis is being fetched',
      (tester) async {
    ...
    testWidgets('T2.5: Error state display in the analysis pane', (
      tester,
    ) async {
    ...
    testWidgets(
      'T3.1: Switching between encounters rapidly while loading (race conditions)',
      (tester) async {
    ...
    testWidgets(
      'T3.2: Resizing window from mobile to desktop while an encounter is selected',
      (tester) async {
    ...
    testWidgets('T3.3: Filtering the encounter list while an item is selected', (
      tester,
    ) async {
    ...
    testWidgets(
      'T3.4: Multi-pane view behavior mixing cached and non-cached analysis loading',
      (tester) async {
