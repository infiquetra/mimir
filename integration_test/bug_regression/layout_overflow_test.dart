...
void main() {
  ...
  group('Layout Overflow Regression Tests', () {
    testWidgets('TC-OVERFLOW-001: Wallet TabBarView renders without overflow', (
      tester,
    ) async {
      ...
      final tabBarViewParent = column
          .children[4]; // [BalanceCards, SizedBox, TabBar, SizedBox, Expanded(TabBarView)]
    ...
    testWidgets('TC-OVERFLOW-003: Balance cards row handles narrow screens', (
      tester,
    ) async {
    ...
    testWidgets('TC-OVERFLOW-005: Wallet screen survives window resize', (
      tester,
    ) async {
