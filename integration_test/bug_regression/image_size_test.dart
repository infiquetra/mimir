...
void main() {
  ...
  group('EVE Image Size Normalization Regression Tests', () {
    test('TC-SIZE-001: EveTypeIcon normalizes to valid sizes', () {
    ...
    test('TC-SIZE-002: Valid sizes pass through unchanged', () {
    ...
    test('TC-SIZE-003: Edge cases handle gracefully', () {
