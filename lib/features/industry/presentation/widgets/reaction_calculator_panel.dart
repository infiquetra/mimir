...
class ReactionCalculatorPanel extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ReactionCalculatorPanel> createState() =>
      _ReactionCalculatorPanelState();
}

class _ReactionCalculatorPanelState
    extends ConsumerState<ReactionCalculatorPanel> {
  int _runs = 1;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      width: 40,
                      child: Text('$_runs', textAlign: TextAlign.end),
                    ),
                  ],
                ),
                    ...
                    Expanded(
                      child: DropdownButtonFormField<double>(
                        ...
                        items: const [
                          DropdownMenuItem(
                            value: 0.0,
                            child: Text('No Bonus (0%)'),
                          ),
                          DropdownMenuItem(
                            value: 0.02,
                            child: Text('Athanor (2%)'),
                          ),
                          DropdownMenuItem(
                            value: 0.024,
                            child: Text('Athanor T1 Rig (2.4%)'),
                          ),
                          DropdownMenuItem(
                            value: 0.028,
                            child: Text('Athanor T2 Rig (2.8%)'),
                          ),
                          DropdownMenuItem(
                            value: 0.04,
                            child: Text('Tatara (4%)'),
                          ...
                          DropdownMenuItem(
                            value: 0.048,
                            child: Text('Tatara T1 Rig (4.8%)'),
                          ),
                          DropdownMenuItem(
                            value: 0.056,
                            child: Text('Tatara T2 Rig (5.6%)'),
                          ),
                        ],
                        onChanged: (v) {
                          if (v != null) {
                            setState(() => _facilityMaterialBonus = v);
                          }
                        },
                      ),
                    ),
