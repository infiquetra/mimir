...
void main() {
  group('WindowType Extension Tests', () {
    test('defaultSize returns correct values for all types', () {
      ...
      expect(WindowType.skills.defaultSize, (width: 1800.0, height: 1200.0));
      expect(WindowType.wallet.defaultSize, (width: 700.0, height: 600.0));
      expect(WindowType.characters.defaultSize, (width: 1100.0, height: 700.0));
