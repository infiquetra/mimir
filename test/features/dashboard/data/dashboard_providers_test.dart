...
void main() {
  ...
  group('allCharacterBalancesProvider', () {
    ...
    test(
      'should return balances for all characters with wallet data',
      () async {
        ...
        final result = await container.read(
          allCharacterBalancesProvider.future,
        );
  ...
  group('allCharacterSkillQueuesProvider', () {
    test('should return empty map when no characters exist', () async {
      final result = await container.read(
        allCharacterSkillQueuesProvider.future,
      );
      expect(result, isEmpty);
    });
  ...
  group('nextSkillsCompletingProvider', () {
    test(
      'should return empty list when no characters exist',
      () async {
        ...
        final completions = await container.read(
          nextSkillsCompletingProvider.future,
        );
    ...
    test(
      'should return next skill per character sorted by finish time',
      () async {
    ...
    test(
      'should return first skill with finish date per character',
      () async {
        final now = DateTime.now();
    ...
    test(
      'should handle characters with empty queues',
      () async {
        final now = DateTime.now();
