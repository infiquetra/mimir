...
/// [EsiClient] fake that returns a [Response] whose [data] is a [Map],
/// causing the repository's runtime `is! List` check to fail.
class _FakeEsiClientReturningMap implements EsiClient {
  @override
