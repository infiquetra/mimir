...
void main() {
  patrolWidgetTest('Fitting E2E - Drag and Drop updates StatsPanel', ($) async {
    ...
    await $.pumpWidget(
      TestApp(
        ...
        providerOverrides: [
          ...
          availableModulesProvider(
            SlotType.high,
          ).overrideWith((ref) => [mockModule]),
    ...
    // The FittingEditor shows the fitting wheel
    expect($(FittingEditor).exists, true);
